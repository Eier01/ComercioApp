...
function InputComponent({label,placeholder,type,value,onChange}) {
    return (
        <div className='relative' key={label}>
            <p className='pt-0 pr-2 pb-0 pl-2 absolute mt-[-0.8rem] mr-0 mb-0 ml-2 font-medium text-gray-600 bg-white'>
                {label}
            </p>
            <input
